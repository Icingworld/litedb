...
std::optional<const schema::DefaultExpression &> ColumnEntry::default_expression() const noexcept
{
    return default_expression_;
}

std::optional<const std::string &> ColumnEntry::comment() const noexcept
{
    return comment_;
}
