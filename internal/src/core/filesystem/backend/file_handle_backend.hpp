...
public:
    ...
    // 从指定偏移读取数据；句柄已关闭时返回 ClosedHandle
    ...
    // 从指定偏移写入全部数据；句柄已关闭时返回 ClosedHandle
    ...
    // 将数据追加到文件末尾；句柄已关闭时返回 ClosedHandle
