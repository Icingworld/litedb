...
const BoundExpression & BoundLikeExpression::expression() const noexcept { return *expression_; }
const BoundExpression & BoundLikeExpression::pattern() const noexcept { return *pattern_; }
