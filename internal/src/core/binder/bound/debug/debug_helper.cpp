...
{
    switch (op) {
    case common::UnaryOperator::Negate: return "Negate";
    case common::UnaryOperator::Not: return "Not";
    }
...
{
    switch (op) {
    case common::BinaryOperator::Add: return "Add";
    case common::BinaryOperator::Subtract: return "Subtract";
    case common::BinaryOperator::Multiply: return "Multiply";
    case common::BinaryOperator::Divide: return "Divide";
    case common::BinaryOperator::Modulus: return "Modulus";
    case common::BinaryOperator::Power: return "Power";
    }
