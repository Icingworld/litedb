...
common::DatabaseId BoundDescribeCollectionStatement::database_id() const noexcept
{
    return database_id_;
}
...
const std::string & BoundDescribeCollectionStatement::collection_name() const noexcept
{
    return collection_name_;
}

void BoundDescribeCollectionStatement::accept(BoundStatementVisitor & visitor) const
{
    visitor.visit(*this);
}
