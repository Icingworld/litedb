...
common::DatabaseId BoundDropCollectionStatement::database_id() const noexcept
{
    return database_id_;
}
...
const std::string & BoundDropCollectionStatement::collection_name() const noexcept
{
    return collection_name_;
}

bool BoundDropCollectionStatement::if_exists() const noexcept
{
    return if_exists_;
}

void BoundDropCollectionStatement::accept(BoundStatementVisitor & visitor) const
{
    visitor.visit(*this);
}
