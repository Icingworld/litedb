...
const std::string & BoundDropDatabaseStatement::database_name() const noexcept
{
    return database_name_;
}

bool BoundDropDatabaseStatement::if_exists() const noexcept
{
    return if_exists_;
}

void BoundDropDatabaseStatement::accept(BoundStatementVisitor & visitor) const
{
    visitor.visit(*this);
}
