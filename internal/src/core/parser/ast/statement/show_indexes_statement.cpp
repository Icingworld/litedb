...
ShowIndexesStatement::ShowIndexesStatement(std::string collection_name, AstNodeLocation location) noexcept
...
void ShowIndexesStatement::accept(AstNodeVisitor & visitor) const
{
    visitor.visit(*this);
}
