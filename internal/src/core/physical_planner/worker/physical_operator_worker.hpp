...
/**
 * @brief 逻辑算子到物理算子的递归 lowering worker
 */
...
public:
     ...
     * @warning 该成员函数会消耗 logical_operator 的所有权
     */
    [[nodiscard]]
...
private:
    [[nodiscard]] std::unique_ptr<op::PhysicalOperator> visit_scan_operator(
        logical_planner::op::LogicalScanOperator & logical_operator
    );
    [[nodiscard]] std::unique_ptr<op::PhysicalOperator> visit_filter_operator(
        logical_planner::op::LogicalFilterOperator & logical_operator
    );
    [[nodiscard]] std::unique_ptr<op::PhysicalOperator> visit_projection_operator(
        logical_planner::op::LogicalProjectionOperator & logical_operator
    );
    [[nodiscard]] std::unique_ptr<op::PhysicalOperator> visit_order_by_operator(
        logical_planner::op::LogicalOrderByOperator & logical_operator
    );
    [[nodiscard]] std::unique_ptr<op::PhysicalOperator> visit_limit_operator(
